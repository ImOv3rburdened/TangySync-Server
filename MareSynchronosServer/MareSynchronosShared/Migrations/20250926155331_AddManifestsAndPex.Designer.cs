...
namespace MareSynchronosServer.Migrations
{
    ...
    [Migration("20250926155331_AddManifestsAndPex")]
    partial class AddManifestsAndPex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.Manifest", b =>
                {
                    ...
                    b.Property<string>("PieceHashesJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("piece_hashes_json");
                    ...
                    b.HasIndex("CreatedUtc")
                        .HasDatabaseName("ix_manifests_created_utc");

                    b.ToTable("manifests", (string)null);
                });

            modelBuilder.Entity("MareSynchronosShared.Models.P2PPeer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_p2p_peers");

                    b.HasIndex("Area")
                        .HasDatabaseName("ix_p2p_peers_area");

                    b.HasIndex("FileHash")
                        .HasDatabaseName("ix_p2p_peers_file_hash");

                    b.HasIndex("LastSeenUtc")
                        .HasDatabaseName("ix_p2p_peers_last_seen_utc");

                    b.ToTable("p2p_peers", (string)null);
                });
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.Manifest", b =>
                {
                    b.HasOne("MareSynchronosShared.Models.FileCache", "FileCache")
                        .WithOne()
                        .HasForeignKey("MareSynchronosShared.Models.Manifest", "FileHash")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_manifests_files_file_hash");
